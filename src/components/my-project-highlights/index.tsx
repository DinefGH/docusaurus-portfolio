...
const MyProjectHighlights: React.FC<ProjectHighlightsProps> = ({ headline, projects, seeMoreHref }) => {
        ...
        <div className={styles.grid}>
          ...
          <ol className={styles.list} aria-label="Project list">
            ...
            {seeMoreHref && (
              <li className={styles.moreRow}>
                <a className={styles.moreLink} href={seeMoreHref}>↳ see more projects</a>
              </li>
            )}
          </ol>
          ...
          <article className={styles.card} aria-live="polite">
            ...
            <div className={styles.actions}>
              {active.docsUrl && (
                <a className={styles.primaryBtn} href={active.docsUrl} target="_blank" rel="noreferrer">
                  Documentation
                </a>
              )}
              {active.repoUrl && (
                <a className={styles.secondaryBtn} href={active.repoUrl} target="_blank" rel="noreferrer">
                  GitHub
                </a>
              )}
              {active.liveUrl && (
                <a className={styles.secondaryBtn} href={active.liveUrl} target="_blank" rel="noreferrer">
                  Live
                </a>
              )}
            </div>
